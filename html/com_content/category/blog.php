...
?>
<div class="blog<?php echo $this->pageclass_sfx; ?> content-category-blog" itemscope itemtype="https://schema.org/Blog">
  ...
  <?php if (!empty($this->lead_items)) : ?>
    <div class="items-leading clearfix"><!-- start items-leading -->
  ...
  <?php if (!empty($this->intro_items)) : ?>
    <?php foreach ($this->intro_items as $key => &$item) : ?>
      <div class="items-row clearfix <?php echo ($item->state == 0 ? ' system-unpublished' : null); ?>">
          <div class="item"
               itemprop="blogPost" itemscope itemtype="https://schema.org/BlogPosting">
                 <?php
                 $this->item = &$item;
